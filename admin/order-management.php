    ...
    <div id="main-wrapper">
        ...
        <div id="page-content" class="dashboardPage orderManagementPage">
            <div class="dashboard-wrap">
                ...
                <!-- ═══ ORDER DETAIL ═══ -->
                <div id="om-detail" class="prof-section">

                    <h2 class="prof-heading mb-4">Order Details</h2>
    ...
    <script>
        $(function() {
            ...
            $('#cancelReasonSubmit').on('click', function() {
                ...
                firstOrder.cancel_reason = reason;
                renderDetail(firstOrder);
            ...
            $(document).on('click', '.om-change-to-pending-btn', function() {
                showConfirm(
                    ...
                    function() {
                        ...
                        if (firstOrder.cancel_reason) {
                            firstOrder.cancel_reason = null;
                        }
                        renderDetail(firstOrder);
