...
$page_title = "Admin Login | Nobility ";
...
<body>
    <div class="container-fluid p-0 auth-container loginPage">
        <div class="row g-0">
            <!-- Left side - Image -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center p-4">
                <div class="modal-body">
                    ...
                    <a href="<?php echo $page_url; ?>/admin/dashboard" class="btn btn-login w-100">Done</a>
                </div>
            </div>
        </div>
    </div>
